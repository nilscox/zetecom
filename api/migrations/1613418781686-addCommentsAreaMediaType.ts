...
export class addCommentsAreaMediaType1613418781686 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "comments_area_information_media_enum" AS ENUM('20minutes', 'francesoir', 'lefigaro', 'lemonde', 'leparisien', 'lepoint', 'lesechos', 'liberation', 'scienceetvie', 'skeptikon', 'youtube')`);
