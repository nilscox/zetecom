...
const Usage: React.FC = () => (
  <div style={{ flex: 4 }}>
    ...
    <p>
      Lorsque vous visitez un site qui intègre une zone de commentaires, l'icône de
    ...
    <p>
      ...
      vous présenter les réactions les plus impactantes lorsque vous choisissez le tri par
      pertinence.
    </p>
    ...
    <ul>
      <li>
        ...
        message. Elle apporte des éléments me convaincant.
      </li>
      <li>
        👎 Je réfute : je trouve que cette réaction est pertinente mais je ne suis pas d'accord avec le message.
        La méthode utilisée me semble incorrecte ou biaisée, ou j'ai une preuve du contraire.
      </li>
      <li>
        🧐 Je suis septique : je trouve que cette réaction est pertinente. Elle n'apporte pas assez d'éléments pour me
    ...
    <SubTitle id="Inscription_Connexion">Inscription / Connexion</SubTitle>

    <ImagePopup />

    <p>
      La création d'un compte sur la plateforme vous permettera de devenir membre de la communauté, et de participer
    ...
    <p>
      La qualité des échanges présents sur CDV découlent de l'attention que les membres porterent à la lecture de la
      charte. Il est donc primordial de consacrer une dixaine de minutes à sa lecture avant de vous inscrire. La charte
      n'a rien à voir avec des conditions générales d'utilisations ou des textes de loi, mais énnonce au contraire
      quelques règles, simples et compréhensibles, apportant aux débats un cadre d'écoute, propice aux réflexions.
    </p>

    <p>
      L'extension chrome vous permet de vous inscrire et vous connecter, via la popup qui apparait en cliquant sur
      son icône, en haut à droite de votre navigateur. Après votre inscription, vous receverez un e-mail de bienvenue,
    ...
    <p>
      ...
      nouveau mot de passe, en cliquant sur "mot de passe oublié". Vous receverez un email contenant un lien pour le
      changer.
    </p>
    ...
    <Note>
      ...
      <Link to="/usage#inscription">inscription</Link> de cette page pour en créer un si vous n'en avez pas déjà.
    </Note>

    <SubTitle id="Rejoindre_les_modérateurs">Rejoindre les modérateurs</SubTitle>

    <p>
      La modération des échanges présents sur CDV est assurée par des membres bénévols de la communauté. Et nous
