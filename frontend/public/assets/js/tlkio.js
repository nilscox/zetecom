!(function(t, e) {
  var i = function() {
    ...
    n = function() {
      ...
      (a.textContent =
        ...
        (o.src = "//tlk.io/images/logo.png"),
        (o.className = "tlkio-pulse"),
        "static" == t.getComputedStyle(n).position &&
  ...
  // load tlkio when the react component is mounted
  var onmessage = (m) => m  && m.data && m.data.type && m.data.type === 'TLKIO_READY' && n();

  t.addEventListener
    ? t.addEventListener("message", onmessage, !1)
    : t.attachEvent("onmessage", onmessage);
})(window, document);
