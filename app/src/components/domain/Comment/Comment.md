...
import StyleguidistComment from './Comment.styleguidist';
...
const loth = makeUser({ id: 4, nick: 'Le Roi Loth' });
...
<StyleguidistComment user={user} comment={druide} replies={replies} />;
```
